        ...
        children: [
          {
            ...
            children: [
              ...
              },
              {
                ...
                children: [
                  { label: 'начинал с тестирования ПО WEB-приложения: разрабатывал кейс-тесты / чек-листы для тестирования WEB-ПО со всеми видами тестирования. В качестве автоматизированного ПО для тестирования WEB-приложений нашёл и применил программный продукт Browser Automation Studio. Для регистрации багов применено открытое серверное веб-приложение для управления проектами и задачами Redmine.' }
                ]
              },
              {
